...
require_once 'Zend/Barcode/Renderer/Memory/Manager.php';
/** Zend_Memory_Value */
require_once 'Zend/Barcode/Renderer/Memory/Value.php';
/** Zend_Memory_Container */
require_once 'Zend/Barcode/Renderer/Memory/Container.php';
/** Zend_Memory_Exception */
require_once 'Zend/Barcode/Renderer/Cache.php';
/**
 * @category   Zend
 * @package    Zend_Memory
 * @copyright  Copyright (c) 2005-2015 Zend Technologies USA Inc. (http://www.zend.com)
