...
/** Zend_Pdf_Page */
 require_once 'Zend/Barcode/Renderer/Pdf/Page.php';

/** Zend_Pdf_Style */
 require_once 'Zend/Barcode/Renderer/Pdf/Style.php';

/** Zend_Pdf_Color_GrayScale */
 require_once 'Zend/Barcode/Renderer/Pdf/Color/GrayScale.php';

/** Zend_Pdf_Color_Rgb */
 require_once 'Zend/Barcode/Renderer/Pdf/Color/Rgb.php';

/** Zend_Pdf_Color_Cmyk */
 require_once 'Zend/Barcode/Renderer/Pdf/Color/Cmyk.php';

/** Zend_Pdf_Color_Html */
 require_once 'Zend/Barcode/Renderer/Pdf/Color/Html.php';

/** Zend_Pdf_Image */
 require_once 'Zend/Barcode/Renderer/Pdf/Image.php';

/** Zend_Pdf_Font */
 require_once 'Zend/Barcode/Renderer/Pdf/Font.php';

/** Zend_Pdf_Resource_Extractor */
 require_once 'Zend/Barcode/Renderer/Pdf/Resource/Extractor.php';

/** Zend_Pdf_Canvas */
require_once 'Zend/Barcode/Renderer/Pdf/Canvas.php';

require_once 'Zend/Barcode/Renderer/Pdf/Trailer/Generator.php';
require_once 'Zend/Barcode/Renderer/Pdf/Exception.php';
require_once 'Zend/Barcode/Renderer/Pdf/Parser.php';


/** Internally used classes */
require_once 'Zend/Barcode/Renderer/Pdf/Element.php';
require_once 'Zend/Barcode/Renderer/Pdf/ElementFactory.php';
require_once 'Zend/Barcode/Renderer/Pdf/Element/Array.php';
require_once 'Zend/Barcode/Renderer/Pdf/Element/String/Binary.php';
require_once 'Zend/Barcode/Renderer/Pdf/Element/Boolean.php';
require_once 'Zend/Barcode/Renderer/Pdf/Element/Dictionary.php';
require_once 'Zend/Barcode/Renderer/Pdf/Element/Name.php';
require_once 'Zend/Barcode/Renderer/Pdf/Element/Null.php';
require_once 'Zend/Barcode/Renderer/Pdf/Element/Numeric.php';
require_once 'Zend/Barcode/Renderer/Pdf/Element/String.php';
  ...
  /**** Class Constants ****/
    ...
    static public function getMemoryManager()
    {
        if (self::$_memoryManager === null) {
            require_once 'Zend/Barcode/Renderer/Memory.php';
    ...
    protected function _dumpPages()
    {
        ...
        // Refresh outlines
        require_once 'Zend/Barcode/Renderer/Pdf/RecursivelyIteratableObjectsContainer.php';
