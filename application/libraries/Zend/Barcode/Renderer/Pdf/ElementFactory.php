...
require_once 'Zend/Barcode/Renderer/Pdf/ElementFactory/Interface.php';
require_once 'Zend/Barcode/Renderer/Pdf/ElementFactory/Proxy.php';

require_once 'Zend/Barcode/Renderer/Pdf/Element/Object.php';
...
class Zend_Pdf_ElementFactory implements Zend_Pdf_ElementFactory_Interface
{
    ...
    {
       require_once 'Zend/Barcode/Renderer/Pdf/Element/Object/Stream.php';
    ...
    public function listModifiedObjects($rootFactory = null)
    {
        ...
        $result = array();
        require_once 'Zend/Barcode/Renderer/Pdf/UpdateInfoContainer.php';
